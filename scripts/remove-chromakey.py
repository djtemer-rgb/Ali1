...
def main():
    assets = [
        ("1 Панда — Бамбу.png", "01_panda_bambu.png"),
        ("5 Хаски — Фрост.png", "05_husky_frost.png"),
        ("7 Лисе\u0308нок — Фокси.png", "07_fox_foxy.png"),
        ("15 Хамелеончик — Спектр.png", "15_chameleon_spectrum.png"),
    ]
    
    src_dir = "images/1 - runner"
    dest_dir = "public/images/bonus-games/runner"
    ...
    for src_name, dest_name in assets:
        ...
        if os.path.exists(src_path):
            ...
            # Check without unicode normalisation
            alt_name = src_name.replace("Лисе\u0308нок", "Лисёнок")
            alt_path = os.path.join(src_dir, alt_name)
            if os.path.exists(alt_path):
                process_chroma_key(alt_path, dest_path)
            else:
                # Find any file starting with number
